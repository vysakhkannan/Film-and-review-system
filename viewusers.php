 ...
 include("adminheader.php");
   ...
   if(isset($_GET['submit'])){
      ...
      if($_GET['nosearch']=="" AND $_GET['namesearch']==""){
        ...
        $sql = "SELECT * FROM register WHERE name ='$name' AND phno = '$phno'";
      }
...
<form class="sea" method="get" action="" >
  ...
  <input class="searc" type="tel" name="nosearch" placeholder="phone no" value="<?php if(isset($_GET['nosearch'])) echo $_GET['nosearch']; ?>">
...
<tr>
    ...
    <td><a href="delusers.php?username=<?php echo $r['username']; ?>" onClick="return check()">DELETE</a></td>
   <!-- <td>
