...
if(isset($_POST['submit']))
{
    ...
    $sql = "INSERT INTO tvseriesreview (tvseriestitle,username,reviewrating,reviewcontent,report) VALUES ('$title','$username','$rating','$review','0')";
...
<form class="modal-content3" action="reviewtvseries.php" method="post">
