...
if(isset($_POST['submit']))
{
    ...
    $sql2 = "UPDATE `tvseries` SET `platform`='$nplatform', `category`='$ncategory', `year`='$nyear',`language`='$nlanguage', `director`='$ndirector', `writer`='$nwriter', `maleactor`='$nmaleactor', `femaleactor`='$nfemaleactor', `cover`='$ncover', `trailer`='$ntrailer', `storyline`='$nstoryline' WHERE title='$title'";
