...
//select statement
$query_str = "SELECT * FROM movieswishlist where username='$username'" ;
...
<!DOCTYPE html>
<html>
<title>My Movies Wishlist</title>
<head>
<meta charset="utf-8">
...
<section>
              ...
              <div class="container wrapper">
                ...
                <h2 style="color:white"><center>MY MOVIES WISHLIST </center></h2>
			        <?php
			        $i = 0;
				        ...
				        <div class="col-xs-4">
					        <div class="thumbnail">
						        ...
						        <div class="caption">
									...
									<br>
									<?php
									echo "<a onclick='return check()' href='delmovieswishlist.php?tit=" . $result_row['title'] . "' >DELETE FROM WISHLIST</a>";
