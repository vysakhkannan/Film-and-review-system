 ...
 include("adminheader.php");
   ...
   if(isset($_GET['submit'])){
      ...
      if($_GET['nosearch']=="" AND $_GET['namesearch']==""){
        $sql = "SELECT * FROM tvseriesreview";
      }
      else if($_GET['nosearch']!="" AND $_GET['namesearch']==""){
         $sql = "SELECT * FROM tvseriesreview WHERE `year` = '$phno'";
      }
      else if($_GET['nosearch']=="" AND $_GET['namesearch']!=""){
         $sql = "SELECT * FROM tvseriesreview WHERE tvseriestitle ='$name'";
      }
      else if($_GET['nosearch']!="" AND $_GET['namesearch']!=""){
        $sql = "SELECT * FROM tvseriesreview WHERE tvseriestitle ='$name' AND   `year` = '$phno'";
      }
...
<!DOCTYPE html>
<html>
<title>View TV Series Review</title>
...
?>
<tr>
    <td><?php echo $r['tvseriestitle']; ?></td>
    <td><?php echo $r['username']; ?></td>
    <td><?php echo $r['reviewrating']; ?></td>
    <td><?php echo $r['reviewcontent']; ?></td>
    <td><?php echo $r['time']; ?></td>

    <td><a href="deltvseriesreview.php?time=<?php echo $r['time']; ?> " onClick="return check()">DELETE</a></td>
   <!-- <td>
