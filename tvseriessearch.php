...
if(isset($_GET['submit'])){
   ...
   if($_GET['nosearch']=="" AND $_GET['namesearch']==""){
     $sql = "SELECT * FROM tvseries";
      ...
      $sql = "SELECT * FROM tvseries WHERE `year` = '$year'";
   }
   else if($_GET['nosearch']=="" AND $_GET['namesearch']!=""){
      $sql = "SELECT * FROM tvseries WHERE title ='$title'";
   }
   else if($_GET['nosearch']!="" AND $_GET['namesearch']!=""){
     $sql = "SELECT * FROM tvseries WHERE title ='$title' AND `year` = '$year'";
   }
...
<body>
  ...
  <video autoplay muted loop id="bg-video">
   ...
   <h2 align="center">Search Your TV Series Here</h2><br />
...
<tr>
    ...
    <td><a href="tvseriesinfo.php?title=<?php echo $r['title']; ?>">MORE INFO</a></td>
   <!-- <td>
